...
import imageTwo from "../../assets/driverBooking/imageTwo.svg";

const HowsItWorks = () => {
    return (
        <div className="w-full bg-[#E7E7E7] py-8 md:py-12">
            <div className="container mx-auto px-4">
                ...
                <p className="figtree text-center text-[14px] md:text-[15px] font-[400] text-[#0F0F0F80] mb-10 md:mb-20 px-4">
                    ...
                    process makes it simple for you to book and confirm <br />{" "}
                    your vehicle of choice online
                </p>
                    ...
                    <div className="w-full lg:w-1/2 space-y-4 md:space-y-6 relative z-10 lg:-mr-16 xl:-mr-32">
                        ...
                        <div className="flex items-center gap-3 md:gap-4 bg-[#FFFFFF] p-4 md:p-6 rounded-[24px] shadow">
                            ...
                            <div>
                                ...
                                <p className="figtree text-[#000000] text-[16px] md:text-[18px] font-[400]">
                                    ...
                                    select the pickup and return dates and
                        ...
                        <div className="flex items-center gap-3 md:gap-4 bg-[#FFFFFF] p-4 md:p-6 rounded-[24px] shadow">
                            ...
                            <div>
                                ...
                                <p className="figtree text-[#000000] text-[16px] md:text-[18px] font-[400]">
                                    ...
                                    and receive an instant confirmation via
                                    email or SMS.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 md:gap-4 bg-[#FFFFFF] p-4 md:p-6 rounded-[24px] shadow">
                            ...
                            <div>
                                ...
                                <p className="figtree text-[#000000] text-[16px] md:text-[18px] font-[400]">
                                    Pick up your car at the designated location
                                    and enjoy your premium driving experience
                                    with our top-quality service.
                                </p>
                            </div>
                        </div>
                    </div>
