...
class WarehouseController extends BaseController
{
    ...
    {
        // No middleware by default (public access to most methods)

        // Only apply vendor role middleware to vendor-specific methods
        $this->middleware(['auth', 'role:vendor'])->only([
            'index',
            'create',
            'store',
            'edit',
        ...
        // Only require authentication for booking methods
        $this->middleware(['auth'])->only(['book', 'userBookings']);
    }
