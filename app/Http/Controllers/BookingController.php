...
class BookingController extends Controller
{
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'age_range' => 'in:21-25,26-35,36-45,46-55,55+',
            ...
            'insurance_type' => 'in:basic,premium',
            'payment_method' => 'in:card,paypal',
            'special_requests' => 'nullable|string',
            'hear_about_us' => 'string|max:255|in:Google Search,Social Media,Friend/Family,Advertisement,Travel Agency,Other',
